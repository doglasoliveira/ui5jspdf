					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Teste photo rotation",
									"targetURL": "#pdfmobile-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"pdfmobile-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pdfmobile",
									"url": sap.ui.require.toUrl("pdfmobile")
								}
							}
						}
					}
